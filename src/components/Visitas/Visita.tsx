...
function Visita() {
  ...
  return (
    <>
      {showModal ? (
        <ModalVisitante fn={() => setShowModal(!showModal)} />
      ) : (
        <div className="flex ">
          <div className=" shadow-sm text-sm ml-4 pl-4 pb-4 w-11/12 bg-white rounded-s-md grid gap-4 grid-cols-3 grid-rows-3 items-center">
            ...
            <p className="col-span-3">
              ...
              <span className="font-semibold">
                ...
                sapiente numquam enim ipsam cumque? Distinctio, expedita
                inventore quae sequi aliquid sed possimus ipsum enim quod
                suscipit dolore vero esse odio.
              </span>
            </p>
          </div>
